...
export interface Mutation {
  ...
  UpdateRideStatus: UpdateRideStatusRsponse;
...
export interface UpdateRideStatusRsponse {
  ok: boolean;
  error: string | null;
}
